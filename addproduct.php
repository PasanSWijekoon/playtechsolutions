                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="select" id="category" onchange="load_brand();">
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"   value="0" min="0" id="qty" />
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="offset-lg-3 col-12 col-lg-6">
                                        <div class="row">
                                            <div class="col-4 image-upload">
                                                <img src="assets/img/icons/upload.svg" class="img-fluid" style="width: 250px;" id="i0" />
                                                
                                            </div>
                                            <div class="col-4 image-upload">
                                                <img src="assets/img/icons/upload.svg" class="img-fluid" style="width: 250px;" id="i1" />
                                              
                                            </div>
                                            <div class="col-4 image-upload">
                                                <img src="assets/img/icons/upload.svg" class="img-fluid" style="width: 250px;" id="i2" />
