...
function userpictureupdate() {
    ...
    r.open("POST", "updateProfilePicture.php", true);
   r.send(f);
}
...
function sendAdminloginrequest() {
  ...
  request.open("POST", "adminsignincheck.php", true);
...
function saveCategory() {
  ...
  var txt = document.getElementById("n").value;
...
function sendChat() {
  ...
  var to = "san@gmail.com";
  var from = "wijekoonpasan055@gmail.com";
  ...
  r.open("GET", "savechat.php?m=" + msg + "&t=" + to + "&f=" + from + "", true);
  r.send();
...
function saveModal() {
  ...
  r.open("POST", "SaveModalProcess.php", true);
  r.send(f);
...
function savecolor() {
  ...
  r.open("POST", "SaveColorProcess.php", true);
  r.send(f);
