...
?>
    ...
    <head>
        ...
        <title>PlayTechSolutions - Brand List</title>
                ...
                <div class="content">
                    <div class="page-header">
                        <div class="page-title">
                            ...
                            <h6>View/Search product Category Brands</h6>
                        </div>
                        <div class="page-btn">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table  datanew">
                                    ...
                                    <tbody>
                                        <?php
                                      $category_rs = Database::search("SELECT brand.id AS brand_id, brand.name AS brand_name, category.id AS category_id, category.name AS category_name FROM brand LEFT JOIN category ON category.id = brand.category_id");
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $category_data["brand_id"]; ?></td>
