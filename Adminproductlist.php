                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="Adminproductlist.php" class="active">Product List</a></li>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="productimgname">
                                                    <a onclick="viewProductModel('<?php echo ($selected_data['id']); ?>');" class="product-img">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="offset-4 col-4">
                                                                <?php
                                                                $image_rs1 = Database::search("SELECT * FROM `images` WHERE `product_id`='" . $selected_data["id"] . "'");
                                                                $image_num1 = $image_rs1->num_rows;
                                                                $image_data1 = $image_rs1->fetch_assoc();
                                                                ?>
                                                                <img src="<?php echo ($image_data1["code"]); ?>" class="img-fluid" style="height: 150px;" />
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <span class="fs-5 overflow-scroll"><?php echo ($selected_data["description"]); ?></span><br />
