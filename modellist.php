...
?>
 ...
 <head>
     ...
     <title>PlayTechSolutions - Model list</title>
                     ...
                     <ul>
                         ...
                         <li class="submenu">
                             ...
                             <ul>
                                 ...
                                 <li><a href="modellist.php" class="active">Modal List</a></li>
         ...
         <div class="page-wrapper">
             <div class="content">
                 <div class="page-header">
                     ...
                     <div class="page-btn">
                         <a href="addmodel.php" class="btn btn-added"><img src="assets/img/icons/plus.svg" class="me-2" alt="img">Add Modal</a>
                     </div>
                 </div>
                         ...
                         <div class="table-responsive">
                                <table class="table  datanew">
                                    ...
                                    <tbody>
                                     ...
                                     FROM brand_has_model
                                     LEFT JOIN brand ON brand.id = brand_has_model.brand_id
                                     LEFT JOIN model ON model.id = brand_has_model.model_id
                                 ");
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $category_data["model_id"]; ?></td>
                                                    <td><?php echo $category_data["model_name"]; ?></td>
                                                    <td><?php echo $category_data["brand_name"]; ?></td>
                                                    <td>Admin</td>
                                                    <td>
