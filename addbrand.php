...
?>
    ...
    <head>
        ...
        <title>PlayTechSolutions - Add Brand</title>
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="addbrand.php" class="active">Add Brand List</a></li>
                ...
                <div class="content">
                    <div class="page-header">
                        <div class="page-title">
                            <h4>Add Brand</h4>
                            <h6>Create new product Category Brand</h6>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <a onclick="saveBrand();" class="btn btn-submit me-2">Submit</a>
